...
OPENAI_RESEARCH_TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "crunchbase.com (startups), statista.com (stats), arxiv.org (site mirror), "
                "semanticscholar.org, grandviewresearch.com (market size), stackshare.io (tech stacks), "
                "glassdoor.com (employer data), producthunt.com (product launches), "
                "macrotrends.net (financials), cbinsights.com (startup intelligence), "
                "bloomberg.com / reuters.com (financial news)."
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Search Wikipedia for background facts, company overviews, technology definitions, "
                "industry history, and market context. Best used early in research to establish "
                "baseline context before going deep. Returns full article extracts (up to 4000 chars each). "
                "Use for: company history, technology explanations, market definitions, geography, "
                "regulatory frameworks, or any factual background that Wikipedia reliably covers."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "Topic or company name to look up.",
                    },
                    "max_results": {
                        "type": "integer",
